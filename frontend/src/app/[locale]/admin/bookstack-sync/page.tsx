  ...
  return (
    <main className="min-h-screen flex flex-col relative overflow-hidden bg-black text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-[-1]">
        <div className="absolute top-1/4 -left-1/4 w-[70vw] h-[70vw] rounded-full bg-cyan-900/10 blur-[120px]" />
        <div className="absolute -bottom-1/4 -right-1/4 w-[60vw] h-[60vw] rounded-full bg-emerald-900/10 blur-[100px]" />
